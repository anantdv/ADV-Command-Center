...
ALLOWED_CREATE_FIELDS = {
    ...
    "Quotation": ["quotation_to", "party_name", "company", "transaction_date", "valid_till", "currency", "conversion_rate", "items"],
    "Sales Order": ["customer", "company", "transaction_date", "delivery_date", "currency", "conversion_rate", "po_no", "po_date", "items"],
    "Purchase Order": ["supplier", "company", "transaction_date", "schedule_date", "currency", "conversion_rate", "set_warehouse", "items"],
    "Sales Invoice": ["customer", "company", "posting_date", "due_date", "currency", "conversion_rate", "items"],
    "Purchase Invoice": ["supplier", "company", "bill_no", "bill_date", "posting_date", "due_date", "currency", "conversion_rate", "items"],
