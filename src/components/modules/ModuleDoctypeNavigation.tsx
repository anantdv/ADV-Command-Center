...
export function ModuleDoctypeNavigation({ moduleName, doctypes }: { moduleName: string; doctypes: ModuleDoctypeInfo[] }) {
  return <section>
    <div className="mb-3 flex items-end justify-between gap-3"><div><h2 className="text-sm font-bold text-slate-900">Standard navigation</h2><p className="mt-1 text-xs text-slate-400">Browse available DocType list views.</p></div></div>
