...
export const useIngestKnowledgeSource=()=>{const client=useQueryClient();return useMutation({mutationFn:knowledgeService.ingestSource,onSuccess:()=>client.invalidateQueries({queryKey:knowledgeKeys.sources})})}
