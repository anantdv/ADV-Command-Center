...
import type { AllowedDoctype, DoctypeSchemaRequest, DoctypeSchemaResponse, DocumentDetailResponse, ErpnextUserContext, GetRecordRequest, ListRecordsRequest, ListRecordsResponse, RecordResponse } from '../types/erpnext'
