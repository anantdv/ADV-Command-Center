...
const moduleRecords: Record<string, string[]> = { accounts:['Trial Balance','General Ledger','Accounts Receivable','Accounts Payable','Journal Entry','Payment Entry'],selling:['Customers','Quotations','Sales Orders','Sales Invoices','Sales Analytics'],stock:['Items','Warehouses','Stock Ledger','Stock Balance','Reorder Report'],buying:['Suppliers','Request for Quotation','Purchase Orders','Purchase Receipts','Purchase Invoices'],crm:['Leads','Opportunities','Customers','Contacts','Sales Pipeline'],projects:['Projects','Tasks','Timesheets','Activity Cost','Project Billing'],support:['Issues','Issue Types','Communications','SLA','Support Analytics'],hr:['Employees','Attendance','Leave Applications','Payroll Entry','Performance'],assets:['Assets','Asset Movement','Asset Maintenance','Asset Repair'],manufacturing:['Bill of Materials','Work Orders','Job Cards','Production Plan','Quality Inspection'] }
