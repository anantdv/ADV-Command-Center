...
import type { Module, ModuleDetailResponse, ModuleListResponse, ModuleRecordsResponse, ModuleReportsResponse } from '../types/module'
...
const icons:Record<string,LucideIcon>={accounting:BadgeIndianRupee,selling:ShoppingCart,buying:PackageCheck,stock:Boxes,crm:Handshake,projects:BriefcaseBusiness,hr:UsersRound,manufacturing:Factory}
