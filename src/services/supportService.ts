...
import type { AiHelpRequest, AiHelpResponse, CreateTicketRequest, EscalateSupportRequest, Ticket } from '../types/support'
...
export const escalateSupport=(request:EscalateSupportRequest):Promise<Ticket>=>apiClient.post('/api/support/escalate',request)
